...
def sample_config():
    ...
    return {
        "processing": {"moving_average_window": 3, "anomaly_threshold": 2.0},
        "alerts": {
            "temperature": {"high_threshold": 35, "low_threshold": 5},
            "wind_speed": {"high_threshold": 60},
            "precipitation": {"high_threshold": 50},
        },
    }
